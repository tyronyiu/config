...
vim.keymap.set('n', '<leader>sk', require('telescope.builtin').keymaps, { desc = '[S]earch [F]iles' })
...
local on_attach = function(_, bufnr)
  ...
  vim.api.nvim_buf_create_user_command(bufnr, "RemoveUnused", function(_)
    ...
    vim.lsp.buf.execute_command(params)
  end, { desc = "Remove unused in current buffer with LSP" })

  nmap('<leader>oi', function()
    organize_imports()
  end, '[O]rganise [I]mports')
  ...
  nmap('<leader>ami', function()
    add_missing_imports()
  end, '[A]dd [M]issing [I]mports')
